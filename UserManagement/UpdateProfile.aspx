<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Epathshala.master" AutoEventWireup="true"
    CodeFile="UpdateProfile.aspx.cs" Inherits="UserManagement_UpdateProfile" %>
            ...
            <div class="ActivityContent">
                ...
                <div class="ActivityContent">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 25%; text-align: right; height: 35px; padding-right: 10px;">
                        ...
                        <tr>
                            <td style="width: 20%; text-align: right; height: 35px; padding-right: 10px;">
                ...
                <td>
                    ...
                    &nbsp;<asp:RequiredFieldValidator ID="rfvpassword" runat="server" ControlToValidate="tpassword"
                        ...
                        <tr>
                            <td style="text-align: right; height: 70px; padding-right: 10px;">
