<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AboutUs.aspx.cs" Inherits="OtherPages_AboutUs" MasterPageFile="~/MasterPage/CommonHeaderFooter.master" %>
...
<div class="row">
        <div class="col-sm-12">
            <div class="sub-banner">
                <img class="img-responsive margin-bottom-20" src="../App_Themes/Green/Images/about-us-banner.jpg"
                    alt="" />
            </div>
            <div class="main-content-part" style="text-align:justify">
                <p>
                ...
                <ul class="ul-list-style" >
                    <li style="text-align:justify">It is concept and syllabus based detailed teaching method using visual aids like
                        graphics, animation, slideshows and videos.</li>
                    <li style="text-align:justify">Learning is enriched through use of technological gadgets (tablets, computers, etc.),
                        publications (study material like worksheets, MCQs, etc.) and various other teaching-learning
                        resources.</li>
                </ul>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.puerto-menu li:nth-child(2) a').addClass('active');
        });
    </script>
</asp:Content>
