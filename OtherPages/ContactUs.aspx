<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContactUs.aspx.cs" Inherits="OtherPages_ContactUs"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div style="box-shadow: none; margin-top: 15px;" class="main-content-part">
                    <h1>
                        Contact us</h1>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.puerto-menu li:nth-child(3) a').addClass('active');
        });
    </script>
</asp:Content>
