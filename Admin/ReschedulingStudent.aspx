<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Epathshala.master" AutoEventWireup="true"
    CodeFile="ReschedulingStudent.aspx.cs" Inherits="Admin_ReschedulingStudent" Culture="auto"
    ...
    <table cellpadding="0" cellspacing="0" class="RoundTop InnerTableStyle TableControl"
        ...
        <tr>
            <td class="Header12 GridViewHeadercssTestAssessment RoundTop">
                <asp:Label ID="lblTitle" runat="server" Text="Student Rescheduling Approval" meta:resourcekey="lblTitleResource1"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <asp:GridView ID="grdRescheduling" runat="server" DataKeyNames="SReSchedulingID,BMSSCTID,ChapterID,TopicID,StudentID"
                    AutoGenerateColumns="False" OnRowCommand="grdRescheduling_RowCommand" OnRowDataBound="grdRescheduling_RowDataBound"
                    meta:resourcekey="grdReschedulingResource1" EmptyDataText="No Records Found"
                    ForeColor="Black" SkinID="NoEmptyMsg">
                    <Columns>
                        ...
                        <asp:BoundField DataField="StudentName" HeaderText="Student" SortExpression="StudentName"
                            ItemStyle-Width="120px" meta:resourcekey="BoundFieldResource1">
                        ...
                        <asp:BoundField DataField="Standard" HeaderText="Standard" SortExpression="Standard"
                            ItemStyle-Width="120px" meta:resourcekey="BoundFieldResource3">
                            <ItemStyle Width="120px"></ItemStyle>
                        </asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="End Date" SortExpression="EndeDate" ItemStyle-Width="100px"
                            ...
                            <ItemTemplate>
                                ...
                                <asp:CompareValidator ID="CMPVDATE" runat="server" ErrorMessage="EndDate Must be Grater Then Start Date."
                                    Text="*" ValidationGroup="Grid" Operator="GreaterThan" ControlToValidate="txtEndDate"
                                    ControlToCompare="txtStartDate" CultureInvariantValues="True" meta:resourcekey="CMPVDATEResource1"></asp:CompareValidator>
                            </ItemTemplate>
                            <ItemStyle Width="100px"></ItemStyle>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Approve" meta:resourcekey="TemplateFieldResource4">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnApprove" runat="server" CommandArgument="SReSchedulingID,BMSSCTID"
