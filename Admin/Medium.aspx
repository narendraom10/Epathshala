<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Epathshala.master" AutoEventWireup="true"
    CodeFile="Medium.aspx.cs" Inherits="Admin_Medium" Culture="auto" meta:resourcekey="PageResource2"
    UICulture="auto" %>
                ...
                <asp:UpdatePanel ID="upDetails" runat="server">
                    <ContentTemplate>
                        <table id="tblGrid" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="grvSYS_Mediumdetail" runat="server" AllowPaging="True" AutoGenerateColumns="False"
