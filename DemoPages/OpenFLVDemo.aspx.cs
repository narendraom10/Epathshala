...
public partial class DemoPages_OpenFLVDemo : System.Web.UI.Page
{
    # region Variables
        ...
        if (!IsPostBack)
        {
            ...
            if (FullPath != string.Empty)
            {
                ...
                else if (ext.ToString().Equals(".mp4"))
                {
                    ...
                    builder.Append("<div style=\"position:absolute; height:90%; width:100%; overflow:hidden;\">");
                    builder.Append("<video width=\"100%\" height=\"auto\" style=\"max-height:100%\" preload  controls autoplay>");
                    builder.Append("<source type=\"video/mp4\" codecs=\"avc1.42E01E, mp4a.40.2\" SRC=\"../Dashboard/SecurityHandler.ashx?param=" + DateTime.Now.Ticks.ToString() + "\" >");
                    ...
                    builder.Append("<PARAM name=\"SRC\" VALUE=\"" + "../Dashboard/SecurityHandler.ashx?param=" + DateTime.Now.Ticks.ToString() + "" + "\">");
                    builder.Append("<PARAM name=\"AUTOPLAY\" VALUE=\"true\">");
                    builder.Append("<PARAM name=\"CONTROLLER\" VALUE=\"false\">");
                    builder.Append("<EMBED SRC=\"" + "..../Dashboard/SecurityHandler.ashx?param=" + DateTime.Now.Ticks.ToString() + "" + "\" WIDTH=\"950\" HEIGHT=\"630\" AUTOPLAY=\"true\" CONTROLLER=\"false\" PLUGINSPAGE=\"http://www.apple.com/quicktime/download/\">");
