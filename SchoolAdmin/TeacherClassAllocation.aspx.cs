...
public partial class SchoolAdmin_TeacherClassAllocation : System.Web.UI.Page
{
    ...
    private void bindgrvEmployeedetail()
    {
        ...
        dsSelect = BAL_Employee.BAL_Employee_SelectBySchoolID(Convert.ToInt32(Session["SchoolID"]), "SelectAll");
    ...
    private void BindEmpStdSubDetailsGrid()
    {
        try
        {
            ...
            dsSelect = BAL_EmployeeStandardDetail.BAL_EmployeeStandardDetail_SelectBySchoolID(Convert.ToInt32(Session["SchoolID"]), SearchCondition);
