<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Epathshala.master" AutoEventWireup="true"
    CodeFile="TeacherClassAllocation.aspx.cs" Inherits="SchoolAdmin_TeacherClassAllocation"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <ul>
                            ...
                            <li class="standarbar">
                                <asp:ImageButton ID="ibtnEdit" runat="server" ImageUrl="~/App_Themes/Responsive/web/edit.png"
                                    OnClick="ibtnEdit_Click" ToolTip="Edit Teacher" OnClientClick="javascript: return Editselectmessage()"
                                    meta:resourcekey="ibtnEditResource1" />
                            </li>
                            <li class="standarbar">
                            ...
                            <li class="standarbar">
                                <asp:ImageButton ID="ibtnDelete" runat="server" ImageUrl="~/App_Themes/Responsive/web/close.png"
                                    OnClick="ibtnDelete_Click" ToolTip="Delete Teacher" OnClientClick="javascript:return deleteselectmessage()"
    ...
    <script type="text/javascript">
        function Editselectmessage() {
            try {
                var TargetBaseControl = document.getElementById('<%= gvEmpStdSubAllocationDetails.ClientID %>');
        ...
        function deleteselectmessage() {
            try {
                ...
                alert("Select any contact to Delete");
            }
        }
    </script>
    <!-- LoaderPart -->
