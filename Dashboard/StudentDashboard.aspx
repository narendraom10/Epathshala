    ...
    <div style="width: 90%; margin: auto; position: relative;">
        <div class="firstpanel">
            <div class="activitydiv activityleft">
                ...
                <asp:RadioButtonList ID="rbSubjectList" runat="server" RepeatDirection="Horizontal"
                    CssClass="RBPadding" RepeatColumns="7" AutoPostBack="True" CellSpacing="10" CellPadding="10"
        ...
        <div class="firstpanel">
            <div class="activitydiv activityleft" id="fsExpiryNotification" runat="server" visible="true">
                <div class="ActivityHeader">
                    <asp:Label ID="lblLegendExpiryNotification" runat="server" CssClass="SubTitle" Text="Package Expiry"
                                        meta:resourcekey="lblLegendExpiryNotificationResource1"></asp:Label>
                </div>
                <div class="ActivityContent">
                    <asp:Label ID="lblExpiryMessage" runat="server" Text="Follwing packages are expire in couple of days."
                    ...
                    <div>
                        <asp:GridView ID="gvSubjectExpiryNotification" runat="server" Visible="true" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="Subject" HeaderText="Subject" meta:resourcekey="BoundFieldResource1" />
                                                    <asp:BoundField DataField="Name" HeaderText="Package Type" meta:resourcekey="BoundFieldResource2" />
                                                    <asp:BoundField DataField="FromDate" HeaderText="Registered On" meta:resourcekey="BoundFieldResource3" />
                                                    <asp:BoundField DataField="ValidTill" HeaderText="Expired On" meta:resourcekey="BoundFieldResource4" />
                                                </Columns>
                                            </asp:GridView>
                                            <asp:GridView ID="gvComboExpiryNotification" runat="server" Visible="False" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="Standard" HeaderText="Standard" meta:resourcekey="BoundFieldResource5" />
                                                    <asp:BoundField DataField="Name" HeaderText="Package Type" meta:resourcekey="BoundFieldResource6" />
                                                    <asp:BoundField DataField="FromDate" HeaderText="Registered On" meta:resourcekey="BoundFieldResource7" />
                                                    <asp:BoundField DataField="ValidTill" HeaderText="Expired On" meta:resourcekey="BoundFieldResource8" />
                                                </Columns>
                                            </asp:GridView>
                    </div>
                </div>
