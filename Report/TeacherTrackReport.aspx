<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Epathshala.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="TeacherTrackReport.aspx.cs" Inherits="Report_TeacherTrackReport"
                ...
                <div class="sidepanel">
                    <div class="activitydivside">
                        <div class="ActivityHeader">
                            <asp:Label ID="lblTitle" runat="server" Text="Teacherwise Track report" meta:resourcekey="lblTitleResource1"></asp:Label>
                        </div>
                        <div class="ActivityContent" id="FirstRpt" runat="server" visible="true">
                            ...
                            <div>
                                ...
                                <asp:TextBox ID="txtFdate" runat="server" meta:resourcekey="txtFdateResource1" CssClass="textBoxCls"></asp:TextBox>
                ...
                <div class="sidepanel1">
                    <div>
                        <div class="activitydivside1">
                            <div class="ActivityHeader">
                                <asp:Label ID="Label1" runat="server" Text="Generate Details"></asp:Label>
                            </div>
                            <div class="ActivityContent" id="secondRpt" runat="server" visible="false">
                                ...
                                <div>
                                    <asp:Label ID="slblteacher" runat="server" Text="Teacher:" CssClass="textlabel" ToolTip="Teacher"
                                        meta:resourcekey="slblteacherResource1"></asp:Label>
                                    <asp:Label ID="slblTeacherValue" runat="server" CssClass="controllabel" ToolTip="Teacher"
                                        meta:resourcekey="slblTeacherValueResource1"></asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:Label ID="slblDuration" runat="server" Text="Duration:" CssClass="textlabel"
                                        meta:resourcekey="slblDurationResource1"></asp:Label>
                                    <asp:Label ID="slblDurationValue" runat="server" CssClass="controllabel" meta:resourcekey="slblDurationValueResource1"></asp:Label>
                                </div>
                            </div>
                        ...
                        <div class="activitydivside1" style="margin-top: 15px;">
                            ...
                            <div class="ActivityContent">
                                ...
                                <uc1:ReportControl ID="ReportControl2" runat="server" Visible="False" />
                                <uc1:ReportControl ID="ReportControl3" runat="server" Visible="False" />
