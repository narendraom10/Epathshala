<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Epathshala.master" AutoEventWireup="true"
    CodeFile="TeachersTrack.aspx.cs" Inherits="Report_TeachersTrack" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="sidepanel" >
                ...
                <asp:UpdatePanel runat="server" ID="pnlBMS" ClientIDMode="Static">
                    <ContentTemplate>
                        <div class="Label">
                            Employee</div>
                        <div class="Control">
                            <asp:DropDownList runat="server" ID="ddlEmployee" ClientIDMode="Static" AutoPostBack="True"
                                Width="140px">
                            </asp:DropDownList>
                        </div>
                    </ContentTemplate>
        ...
        <div class="activitydivside1" id="techertrack" runat="server">
            <div class="ActivityHeader">
                Teacher's Track
            </div>
            <div class="activitycontent">
                <div>
                    <asp:Button runat="server" ID="btnexporttoexcel" Text="Export Excel" OnClick="btnexporttoexcel_Click" />
