<%@ Page Title="" Language="C#" MasterPageFile="~/NewPublic/epath2016.Master" AutoEventWireup="true" CodeFile="LoginCancellationPolicy.aspx.cs" Inherits="NewPublic_LoginCancellationPolicy" %>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-9">
                            <h1>Cancellation<strong> Policy</strong></h1>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                                ...
                                <p>
                                    <span lang="EN-US">
                                        As of now we do not provide any option for non-utilization of services
                                ...
                                <p>
                                    <span lang="EN-US">
                                        Though Epathshala’s payment reconciliation team works on a Daily
                                ...
                                <p>
                                    <span lang="EN-US">
                                        Similar to clause as mentioned under ‘Refund towards Failed Transaction’,
